## landscaper-cli component-cli component-archive sources add
...
```
landscaper-cli component-cli component-archive sources add COMPONENT_ARCHIVE_PATH [source file]... [flags]
```
