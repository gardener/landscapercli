...
func FilterForFailedItemsInTree(installationTree []InstallationTree) []InstallationTree {
	filteredInstallationTree := []InstallationTree{}
	for _, installation := range installationTree {
...
func filterFailedExecutions(executionTree ExecutionTree) *ExecutionTree {
	filteredDeployItems := []DeployItemTree{}
...
func filterFailedDeployItems(deployItemTree DeployItemTree) *DeployItemTree {
